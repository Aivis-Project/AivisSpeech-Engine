...
def test_decide_onnx_provider_from_env_rejects_non_minimal_choices(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """The minimal upstream branch keeps CPU/CUDA/DirectML on the existing path."""

    monkeypatch.setenv("VV_ONNX_PROVIDER", "cuda")
